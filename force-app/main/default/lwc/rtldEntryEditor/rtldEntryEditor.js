...
/**
 * @typedef {Object} RtldEntryEditorUpdateEvent
 * @property {MAJAX__RTLD_Entry__mdt} detail
 */

/**
 * @event RtldEntryEditor#update
 * @type {RtldEntryEditorUpdateEvent}
 */

export default class RtldEntryEditor extends LightningElement {
